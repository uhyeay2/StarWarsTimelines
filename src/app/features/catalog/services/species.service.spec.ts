...
describe('SpeciesService', () => {
  ...
  describe('cache invalidation', () => {
    it('invalidates cache after create and re-fetches', async () => {
      ...
      httpMock.expectOne(BASE).flush({ id: 2, name: 'Rodian', homePlanetId: null, homePlanetName: null });
      await promise;

      httpMock.expectOne(BASE).flush([SPECIES, { id: 2, name: 'Rodian', homePlanetId: null, homePlanetName: null }]);
