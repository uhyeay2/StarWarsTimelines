...
import { isContainerOrCollectionUnit } from './unit-type';
...
describe('isContainerOrCollectionUnit', () => {
  it('recognizes season, volume, book, and collection as containers', () => {
    expect(isContainerOrCollectionUnit('Season')).toBe(true);
    expect(isContainerOrCollectionUnit('Volume')).toBe(true);
    expect(isContainerOrCollectionUnit('Book')).toBe(true);
    expect(isContainerOrCollectionUnit('Collection')).toBe(true);
    expect(isContainerOrCollectionUnit('Episode')).toBe(false);
    expect(isContainerOrCollectionUnit('Chapter')).toBe(false);
  });
});
