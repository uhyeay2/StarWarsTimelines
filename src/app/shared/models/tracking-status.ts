...
export const STATUS_IN_PROGRESS: TrackingStatus = 'In progress';
export const STATUS_COMPLETED: TrackingStatus = 'Completed';
export const STATUS_WISH_LISTED: TrackingStatus = 'Wish Listed';
